...
import { isDown } from '../utils/index.js'
  ...
  const player = {
    ...
    drive (game) {
      ...
      */
      ...
      this.sprite.body.velocity.x = this.speed * Math.cos((this.sprite.angle-90)*0.01745);
      this.sprite.body.velocity.y = this.speed * Math.sin((this.sprite.angle-90)*0.01745);
